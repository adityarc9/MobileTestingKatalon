...
Mobile.startApplication('D:\\APIDemos.apk', false)
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), 'Maulana Aditya', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (1)'), 'Hai sayang', 0)
